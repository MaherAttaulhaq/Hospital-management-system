    ...
    <div className="p-8 max-w-lg mx-auto">
        <Card>
            ...
            <CardHeader>
                ...
                <CardDescription>Name is {data.userId}</CardDescription>
            </CardHeader>
            ...
            <CardContent>
                ...
                <div className="space-y-4 mb-6">
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-500 text-sm">{data.appointmentId}</p>
                        <p className="text-gray-500 text-sm">{data.amount}</p>
                        <p className="text-gray-500 text-sm">{data.status}</p>
                    </div>
                </div>
